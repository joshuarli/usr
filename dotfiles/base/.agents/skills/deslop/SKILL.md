...
- Remove guards, fallbacks, and compatibility paths only after verifying redundancy against actual callers and contracts. Passing tests alone is not sufficient.
